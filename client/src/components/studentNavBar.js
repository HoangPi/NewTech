...
export const StudentNavBar = () => {
    ...
    useEffect(() => {
        if (window.location.pathname === '/studenthomepage' || window.location.pathname === '/studentprofile') {
            console.log()
                    ...
                    <div class="container-fluid shadow-sm">
                        <div class="px-3 py-3 d-flex justify-content-center flex-column">
                            ...
                            <div class="navbar-dark bg-primary navigation">
                                <a class="item btn btn-primary navbar-brand fs-3" href="/studenthomepage">Student</a>
                                <button class="item btn btn-primary navbar-toggler" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasNavbar" aria-controls="offcanvasNavbar" aria-label="Toggle navigation">
                        ...
                        <div class="offcanvas offcanvas-end " style={{ width: '300px' }} tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
                            ...
                            <div class="offcanvas-body">
                                <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                                    ...
                                    <li class="nav-item">
                                        <a href="/viewmythesis">
                                            <button className="btn bg-transparent fs-6 px-0" type="submit">Theses</button>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                    ...
                                    <li class="nav-item">
                                        <a href="/jointhesis">
                                            <button className="btn bg-transparent fs-6 px-0" type="submit">Join thesis</button>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                            <a href="#">
